...
SECRET_KEY = 'django-insecure-vn_#@qyh%jz_q_tg%q+hh^%!rdtfkkqf3y5u9&^@9tcxu3u+8$'
...
LOGIN_REDIRECT_URL = '' # перенаправление на страницу для авторизованного пользователя
...
ACCOUNT_FORMS = {'signup': 'mychat.forms.BasicSignupForm'}
